...
import com.denmit99.hairbnb.exception.ErrorMessage;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        try {
            ...
            // If user is not authorized or wants to refresh the token
            ...
            if (email != null && SecurityContextHolder.getContext().getAuthentication() == null) {
                ...
                //TODO probably isValid is enough
            ...
            ErrorMessage error = new ErrorMessage("token.expired", e.getMessage());
